...
import { PaginaParteTrabajo } from '../domain/parte-trabajo.entity';

const LIMIT_MAXIMO = 200;
const LIMIT_POR_DEFECTO = 50;

@Controller('partes-trabajo')
export class ParteTrabajoController {
  constructor(private readonly getListaUseCase: GetPartesTrabajoUseCase) {}
